...
export class SearchComponent implements OnInit {
  ...
  restart() {
    clearInterval(this.backTrackInterval);
  ...
  backTrackPath() {
    this.backTrackInterval = setInterval(() => {
  ...
  findPath() {
    if (this.activeSearch == false) {
      ...
      this.searchInterval = setInterval(() => {
        ...
        if (this.currentNode == null && this.initHomeNodesChecked || this.currentNode == null) {
